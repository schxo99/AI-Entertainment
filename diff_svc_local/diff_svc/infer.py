...
if __name__ == '__main__':
    ...
    project_name="LeeSu"
    directory_path = f'./checkpoints/{project_name}/'
    files_in_directory = os.listdir(directory_path)
    ckpt_files = [file for file in files_in_directory if file.endswith('.ckpt')]
    ckpt_files.sort()
    model_path = os.path.join(directory_path, ckpt_files[-1]) # change ckpt file name to your best ckpt file name
